...
namespace GPManagementApp {
    ...
    public partial class DatabaseGPDataSet1 : global::System.Data.DataSet {
        ...
        private void InitClass() {
            ...
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/DatabaseGPDataSet11.xsd";
        ...
        public partial class patientsDataTable : global::System.Data.TypedTableBase<patientsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public patientsRow AddpatientsRow(string name, string date_of_birth, string address, string phone_number, string gender) {
...
namespace GPManagementApp.DatabaseGPDataSet1TableAdapters {
    ...
    public partial class patientsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[patients] WHERE (([Id_patients] = @Original_Id_patients) AND ([name] = @Original_name) AND ([date_of_birth] = @Original_date_of_birth) AND ([address] = @Original_address) AND ([phone_number] = @Original_phone_number) AND ([gender] = @Original_gender))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[patients] ([name], [date_of_birth], [address], [phone_number], [gender]) VALUES (@name, @date_of_birth, @address, @phone_number, @gender);
SELECT Id_patients, name, date_of_birth, address, phone_number, gender FROM patients WHERE (Id_patients = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[patients] SET [name] = @name, [date_of_birth] = @date_of_birth, [address] = @address, [phone_number] = @phone_number, [gender] = @gender WHERE (([Id_patients] = @Original_Id_patients) AND ([name] = @Original_name) AND ([date_of_birth] = @Original_date_of_birth) AND ([address] = @Original_address) AND ([phone_number] = @Original_phone_number) AND ([gender] = @Original_gender));
SELECT Id_patients, name, date_of_birth, address, phone_number, gender FROM patients WHERE (Id_patients = @Id_patients)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_patients, name, date_of_birth, address, phone_number, gender FROM dbo.p" +
                "atients";
        ...
        public virtual int Delete(int Original_Id_patients, string Original_name, string Original_date_of_birth, string Original_address, string Original_phone_number, string Original_gender) {
        ...
        public virtual int Insert(string name, string date_of_birth, string address, string phone_number, string gender) {
            if ((name == null)) {
        ...
        public virtual int Update(string name, string date_of_birth, string address, string phone_number, string gender, int Original_Id_patients, string Original_name, string Original_date_of_birth, string Original_address, string Original_phone_number, string Original_gender, int Id_patients) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
            ...
            if ((Original_date_of_birth == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_date_of_birth));
            }
            if ((Original_address == null)) {
                throw new global::System.ArgumentNullException("Original_address");
            }
            ...
            this.Adapter.UpdateCommand.Parameters[11].Value = ((int)(Id_patients));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string date_of_birth, string address, string phone_number, string gender, int Original_Id_patients, string Original_name, string Original_date_of_birth, string Original_address, string Original_phone_number, string Original_gender) {
            return this.Update(name, date_of_birth, address, phone_number, gender, Original_Id_patients, Original_name, Original_date_of_birth, Original_address, Original_phone_number, Original_gender, Original_Id_patients);
        }
    }
